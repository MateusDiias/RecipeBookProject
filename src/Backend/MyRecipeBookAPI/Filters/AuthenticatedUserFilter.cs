...
{
    // implementação do atributo. 102
    public class AuthenticatedUserFilter : IAsyncAuthorizationFilter
    {
        private readonly IAccesTokenValidator _accessTokenValidator;
        private readonly IUserReadOnlyRepository _repository;

        public AuthenticatedUserFilter(IAccesTokenValidator accessTokenValidator, IUserReadOnlyRepository repository)
        {
